                ...
                <List style={{
                    ...
                    <FlatList
                        data={[
                            ...
                            {
                                title: 'Rewind Wallet',
                                description: 'Rescan last 500 blocks for missing transactions',
                                icon: {
                                    iconName: 'md-rewind',
                                    IconType: Ionicons,
                                },
    ...
    Alert.alert(
        ...
        [
            {text: 'Rewind', onPress: () => {
                ...
                if (walletBlockCount > 500) {
                    rewindHeight = walletBlockCount - 500;
                }
