...
const Config = new function() {
     ...
     */
    this.coinName = 'Indium';

    /**
     * Prefix for URI encoded addresses
     */
    this.uriPrefix = 'indium://';
     ...
     */
    this.chainLaunchTimestamp = new Date(1000 * 1599334214);
     ...
     */
    this.devFeeAddress = 'ind1HTqnWNfKyXEkAPmJ7whCSjcdib6eDjKhyboaA7Bo7dov53rt82LbVgNVidkE4HPSrxprC1xr3eh1YjdvU7fb5yut6JsFAj';
     ...
     */
    this.defaultDaemon = new Daemon('indiumcoin.ml', 11441);
     ...
     *
     */
    this.repoLink = 'https://github.com/IndiumCrypto/indium-mobile-wallet/issues';
     ...
     */
    this.sloganCreateScreen = 'Easily and quickly transferable.';
     ...
     */
    this.explorerBaseURL = 'http://explorer.indiumcoin.ml/?hash=';
     ...
     */
    this.nodeListURL = 'https://raw.githubusercontent.com/IndiumCrypto/indium-nodes-json/master/nodes.json';
};
